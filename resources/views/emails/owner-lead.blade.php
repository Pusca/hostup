    ...
    <div style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:14px; padding:28px; border:1px solid #e2e8f0;">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:15px;">
            ...
            <tr>
                ...
                <td style="padding:8px 0;"><a href="mailto:{{ $lead->email }}" style="color:#1f6bff;">{{ $lead->email }}</a></td>
            </tr>
            @if ($lead->phone)
                <tr>
                    <td style="padding:8px 0; color:#64748b;">Telefono</td>
                    <td style="padding:8px 0;"><a href="tel:{{ $lead->phone }}" style="color:#1f6bff;">{{ $lead->phone }}</a></td>
                </tr>
            @endif
            @if ($lead->city)
                <tr>
        ...
        <p style="margin:24px 0 0;">
            <a href="{{ route('admin.leads.index') }}" style="display:inline-block; background:#1f6bff; color:#fff; text-decoration:none; padding:12px 20px; border-radius:10px; font-weight:600; font-size:14px;">
                Apri in Richieste
            </a>
        </p>
